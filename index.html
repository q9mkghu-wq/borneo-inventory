...
<div class="container">
  ...
  <div class="section" id="tab-관리">
    ...
    <div class="card">
      ...
      <div class="mgmt-sec"><h4>4단계 — 사이즈</h4><div class="tag-wrap" id="opt-size"></div><div class="add-row"><input type="text" id="inp-size" placeholder="예: 싱글, 슈퍼싱글, 퀸, 킹"><button class="secondary small" onclick="addOptItem('sizes','inp-size')">추가</button></div></div>
